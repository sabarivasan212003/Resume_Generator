...
//                 <div className="row">
//                     <div className="col-3 text-left  " style={{ color: "#00adb5", width: 400 }}> <h4> Professional Experience</h4>
//                     </div>
...
//                     <div className="col-3 text-left" style={{ color: "#00adb5", width: 400 }}><h4>Education</h4>
...
//                     <div className="w-100 mt-4"> </div>
//                     <hr style={{ height: "5px", backgroundColor: "#00adb5" }} />
//                     <div className="col-3 text-left " style={{ color: "#00adb5", width: 400 }}>
//                         <h4 >Key Skills</h4>
//                     </div>
//                     <div>
//                         {skills.map((skills)=>
